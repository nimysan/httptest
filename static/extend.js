        ...
        if (JSON.stringify(content_length_report) !== JSON.stringify({})) {
            ...
            for (let index = 0; index < content_length_report.stats.length; index++) {
                ...
                if (contentLengthCharts.hasOwnProperty(url_stats.safe_name)) {
                    contentLengthCharts[url_stats.safe_name].addValue([url_stats.chnumber, url_stats.crate]);
                    console.log(contentLengthCharts)
                } else {
                    ...
                    contentLengthCharts[url_stats.safe_name].addValue([url_stats.chnumber]);
                }
            }
        }
